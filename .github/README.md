...
- [klik disini](https://github.com/sip-userbot/NandeMusic/blob/master/config/README.md) Untuk Melihat semua vars yang tersedia
</details>
...
- kloning repository
`git clone https://github.com/sip-userbot/NandeMusic &&  cd NandeMusic`
...
- [List Variable](https://github.com/sip-userbot/NandeMusic/blob/master/config/README.md)

### ʟɪsᴛ ᴘᴇʀɪɴᴛᴀʜ
- Klik [disini](https://github.com/sip-userbot/NandeMusic/blob/master/strings/command.yml) untuk melihat semua perintah pada bot music
...
## ᴄᴏɴᴛᴀᴄᴛ
- [ᴄʜᴀɴɴᴇʟ](https://t.me/suportNande)
- [ɢʀᴏᴜᴘ](https://t.me/suportsipuerbot)
- [ᴏᴡɴᴇʀ](https://t.me/Klyuserbot)
